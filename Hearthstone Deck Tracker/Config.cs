...
namespace Hearthstone_Deck_Tracker
{
	public class Config
	{
		...
		[DefaultValue(new[] { DeckPanel.Winrate, DeckPanel.Cards, DeckPanel.CardCounter, DeckPanel.DrawChances, DeckPanel.Fatigue, DeckPanel.TotalStrength, DeckPanel.DeadDeathrattleMinionsCounter })]
		public DeckPanel[] DeckPanelOrderOpponent = { DeckPanel.Winrate, DeckPanel.Cards, DeckPanel.CardCounter, DeckPanel.DrawChances, DeckPanel.Fatigue, DeckPanel.TotalStrength, DeckPanel.DeadDeathrattleMinionsCounter };

		[DefaultValue(new[] { DeckPanel.DeckTitle, DeckPanel.Wins, DeckPanel.Cards, DeckPanel.CardCounter, DeckPanel.DrawChances, DeckPanel.Fatigue, DeckPanel.TotalStrength, DeckPanel.DeadDeathrattleMinionsCounter })]
		public DeckPanel[] DeckPanelOrderPlayer = { DeckPanel.DeckTitle, DeckPanel.Wins, DeckPanel.Cards, DeckPanel.CardCounter, DeckPanel.DrawChances, DeckPanel.Fatigue, DeckPanel.TotalStrength, DeckPanel.DeadDeathrattleMinionsCounter };
		...
		[DefaultValue(new[] { "Deck Title", "Wins", "Cards", "Card Counter", "Draw Chances", "Fatigue Counter", "Total strength", "Dead deathrattle minions counter" })]
